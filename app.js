...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Dropdown for Luminárias
        ...
        .then(data => {
            ...
            // 3. Now add the results as before
            doc.setFontSize(12);
            doc.text("Resultados:", 15, y); y += 8;

            // ...existing code to add the results list...
            ...
            // Set font size smaller for IP
            doc.setFontSize(8);
            // Get page height
            const pageHeight = doc.internal.pageSize.getHeight();
            // 4. Add footer with IP address
